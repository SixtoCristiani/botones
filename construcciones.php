...
<?php
	...
	$descripcionSede['LOC'] = 'Juan Jose Castelli';
	...
	{
		$montos['SAL'] = 'entre $1200 y $1500';
		$montos['TUC'] = 'entre $1200 y $1500';
		$montos['CBA'] = 'entre $1500 y $1800';
		$montos['NQN-RN'] = 'entre $1800 y $2000';
		$montos['ROS'] = 'entre $1500 y $1800';
		$montos['BA'] = 'entre $1800 y $2000';
		$montos['MIS-OBE'] = 'entre $1200 y $1500';
		$montos['MIS-POS'] = 'entre $1200 y $1500';
		$montos['COCHA'] = 'entre $1000 y $1300';
		$montos['LOC'] = 'entre $200 y $500';

		$socios['BA'] = '18 socios de $100';
		$socios['MIS-OBE'] = '12 socios de $100';
		$socios['MIS-POS'] = '12 socios de $100';
		$socios['NQN-RN'] = '18 socios de $100';
		$socios['COCHA'] = '10 socios de $100';
		$socios['TUC'] = '12 socios de $100';
		$socios['CBA'] = '15 socios de $100';
		$socios['SAL'] = '12 socios de $100';
		$socios['ROS'] = '15 socios de $100';
		$socios['LOC'] = '2 socios de $100';
	...
	<body id="top">
		<header id="header">
			<div class="content">
				...
				{
					echo "Confirma tu participación en los <b>Trabajos</b><br/> de $descripcionOrden[$orden] de TECHO en Castelli (Chaco)<br/><br/> Vas a salir desde $descripcionSede[$sede]";
				}
				else
				{
				...
				<h3>¿CÓMO?</h3>
				<ul class="actions">
					<li><a href="#one" class="button icon fa-chevron-down scrolly">Ver opciones de confirmación</a></li>
				</ul>
			</div>
			...
			<header class="major">
				...
				<form id="formulario" action="https://gateway.payulatam.com/ppp-web-gateway" method="post">
					<ul>
						...
						<br/>
						<h4>Monto a Donar:</h4>
						<input type="text" id="item_ammount_1" name="item_ammount_1" value="" onKeyPress="return SoloNumerico(event, this);" Onblur="AplicoFormato(this)" placeholder="<?php echo $montos[$sede]; ?>" required/>
						<br/>
		...
		<footer id="footer">
			...
			<p class="copyright">&copy; Techo Argentina. Credits: <b>Santi M., Fede L. y Agus V.</b></p>
		</footer>
